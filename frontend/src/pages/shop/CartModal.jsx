...
const CartModal = ({ products, isOpen, onClose }) => {
    ...
    const handleRemove = (e, id) => {
        ...
        toast.success("This Product is clear"); // Thông báo xóa thành công
    }
    ...
    return (
        ...
        >
            <div className={`fixed right-0 top-0 md:w-1/3 w-full
                 bg-white h-full overflow-y-auto transition-transform ${isOpen ? 'translate-x-0 ' : '-translate-x-full'}`}
